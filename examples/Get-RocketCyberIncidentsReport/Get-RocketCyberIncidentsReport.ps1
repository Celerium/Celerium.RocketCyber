<#
    ...
    .DESCRIPTION
        The Get-RocketCyberIncidentReport script gets a Incident report from the RocketCyber API.
...
#Region    [ Prerequisites ]
    ...
    $ScriptName = 'Get-RocketCyberIncidentReport'
...
#Region     [ RocketCyber API ]
    ...
    If ($Days) {
        ...
        $Command = Get-RocketCyberIncident -id $id -pageNumber $Page_Number -startDate $TimeSpan
    }
    Else{
        $Command = Get-RocketCyberIncident -id $id -pageNumber $Page_Number
    }
